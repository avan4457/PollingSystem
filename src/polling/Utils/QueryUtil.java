...
public class QueryUtil {
	 ...
	 */
	nodeList = DocumentBuilderFactory.newInstance().newDocumentBuilder().parse(new File(System.getProperty("catalina.base") + "\\wtpwebapps\\Project\\WEB-INF\\UserQuery.xml"))
